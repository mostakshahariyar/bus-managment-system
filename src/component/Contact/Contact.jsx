  ...
  return (
    <div className="flex flex-col w-full h-full bg-[#eaf9e7]">
      ...
      <div className="flex  flex-col justify-center items-center w-[100%]">
        ...
        >
          <div className="w-2/4 flex lg:flex-row flex-col items-center justify-center gap-5">
          ...
          <input
            type="text"
            className="w-2/4 py-2 ps-5"
            required
            placeholder="Subject or topic*"
          />
          <textarea  type="text" className="w-2/4 pt-2 ps-5 h-40" required placeholder="Message*" />
          <div className="w-2/4">
